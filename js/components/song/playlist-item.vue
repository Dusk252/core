<template>
  ...
  >
    <td class="track-number">{{ song.sort_order + 1 || '' }}</td>
    <td class="title" :title="song.title">{{ song.title }}</td>
    <td class="artist" :title="song.artist.name">{{ song.artist.name }}</td>
    <td class="album" :title="song.album.name">{{ song.album.name }}</td>
