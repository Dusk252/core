<template>
  <section id="artistWrapper">
    ...
    <song-list :items="artist.songs" :defaultSortKeys="['song.album.year', 'song.album.name', 'song.disc', 'song.track']" type="artist" ref="songList"/>
...
export default {
  ...
  methods: {
    ...
    playAll (shuffled) {
      playback.playAllByArtist(this.artist, shuffled)
    },
